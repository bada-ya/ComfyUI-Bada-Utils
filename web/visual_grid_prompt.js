...
const ART_STYLES = [
    {
        ...
        name_en: "📷 Photorealistic RAW Photo",
        short_ko: "극실사",
        short_en: "Photo RAW",
        icon: "📷",
    ...
    },
    {
        ...
        name_en: "📐 Character Concept Sheet",
        short_ko: "캐릭터",
        short_en: "Character",
        icon: "📐",
    ...
    },
    {
        ...
        name_en: "🎮 3D CGI / Unreal Engine 5",
        short_ko: "3D",
        short_en: "3D",
        icon: "🎮",
...
const PRESET_GROUPS = [
    {
        group: "얼굴 (헤어부터 쇄골까지)",
        group_en: "Head & Face (Hair to Collarbone)",
        icon: "👤",
        items: [
            { label: "정면", label_en: "Front View", ko: "얼굴 (헤어부터 쇄골까지): 정면", en: "portrait from hair to collarbone, front view, detailed face and hairstyle" },
            { label: "측면", label_en: "Side Profile", ko: "얼굴 (헤어부터 쇄골까지): 측면", en: "portrait from hair to collarbone, side profile view" },
            { label: "45도 측면", label_en: "3/4 View (45°)", ko: "얼굴 (헤어부터 쇄골까지): 45도 측면", en: "portrait from hair to collarbone, three-quarter view, 45-degree angle" },
            { label: "위에서 본", label_en: "High Angle", ko: "얼굴 (헤어부터 쇄골까지): 위에서 본 (하이앵글)", en: "portrait from hair to collarbone, high angle, from above" },
            { label: "아래에서 본", label_en: "Low Angle", ko: "얼굴 (헤어부터 쇄골까지): 아래에서 본 (로우앵글)", en: "portrait from hair to collarbone, low angle, from below" },
            { label: "후면", label_en: "Back View", ko: "얼굴 (헤어부터 쇄골까지): 후면 (뒷모습)", en: "back of head and hairstyle, back view, from behind, collarbone line" }
        ]
    },
    {
        group: "얼굴 초근접",
        group_en: "Extreme Face Close-Up",
        icon: "👁️",
        items: [
            { label: "정면", label_en: "Front View", ko: "얼굴 초근접: 정면", en: "extreme macro close-up of face, front view, macro eyes and lips detail" },
            { label: "측면", label_en: "Side Profile", ko: "얼굴 초근접: 측면", en: "extreme macro close-up of face, side profile view" },
            { label: "45도 측면", label_en: "3/4 View (45°)", ko: "얼굴 초근접: 45도 측면", en: "extreme macro close-up of face, three-quarter view, 45-degree angle" }
        ]
    },
    {
        group: "상반신 가슴까지",
        group_en: "Bust Shot (To Chest)",
        icon: "👚",
        items: [
            { label: "정면", label_en: "Front View", ko: "상반신 가슴까지: 정면", en: "bust shot, upper body to chest, front view, neckline detail" },
            { label: "측면", label_en: "Side Profile", ko: "상반신 가슴까지: 측면", en: "bust shot, upper body to chest, side profile view" },
            { label: "45도 측면", label_en: "3/4 View (45°)", ko: "상반신 가슴까지: 45도 측면", en: "bust shot, upper body to chest, three-quarter view" },
            { label: "위에서 본", label_en: "High Angle", ko: "상반신 가슴까지: 위에서 본 (하이앵글)", en: "bust shot, upper body to chest, high angle, looking down" },
            { label: "아래에서 본", label_en: "Low Angle", ko: "상반신 가슴까지: 아래에서 본 (로우앵글)", en: "bust shot, upper body to chest, low angle, looking up" }
        ]
    },
    {
        group: "상반신 허리까지",
        group_en: "Waist Shot (To Waist)",
        icon: "👗",
        items: [
            { label: "정면", label_en: "Front View", ko: "상반신 허리까지: 정면", en: "waist shot, upper body to waist, front view, outfit detail" },
            { label: "측면", label_en: "Side Profile", ko: "상반신 허리까지: 측면", en: "waist shot, upper body to waist, side profile view" },
            { label: "45도 측면", label_en: "3/4 View (45°)", ko: "상반신 허리까지: 45도 측면", en: "waist shot, upper body to waist, three-quarter view" },
            { label: "위에서 본", label_en: "High Angle", ko: "상반신 허리까지: 위에서 본 (하이앵글)", en: "waist shot, upper body to waist, high angle, from above" },
            { label: "아래에서 본", label_en: "Low Angle", ko: "상반신 허리까지: 아래에서 본 (로우앵글)", en: "waist shot, upper body to waist, low angle, from below" }
        ]
    },
    {
        group: "가슴 클로즈업",
        group_en: "Chest & Neckline Focus",
        icon: "✨",
        items: [
            { label: "정면", label_en: "Front View", ko: "가슴 클로즈업: 정면", en: "close-up shot focused on chest and neckline, front view, outfit detail" },
            { label: "측면", label_en: "Side Profile", ko: "가슴 클로즈업: 측면", en: "close-up shot focused on chest, side profile view" },
            { label: "45도 측면", label_en: "3/4 View (45°)", ko: "가슴 클로즈업: 45도 측면", en: "close-up shot focused on chest, three-quarter angle" },
            { label: "위에서 본", label_en: "High Angle", ko: "가슴 클로즈업: 위에서 본 (하이앵글)", en: "close-up shot focused on chest, high angle, top-down view" },
            { label: "아래에서 본", label_en: "Low Angle", ko: "가슴 클로즈업: 아래에서 본 (로우앵글)", en: "close-up shot focused on chest, low angle, looking up" }
        ]
    },
    {
        group: "전신",
        group_en: "Full Body Shot",
        icon: "🧍",
        items: [
            { label: "정면", label_en: "Front View", ko: "전신: 정면", en: "full body shot, front view, standing pose" },
            { label: "측면", label_en: "Side Profile", ko: "전신: 측면", en: "full body shot, side profile view, standing" },
            { label: "45도 측면", label_en: "3/4 View (45°)", ko: "전신: 45도 측면", en: "full body shot, three-quarter view, 45-degree angle standing" },
            { label: "후면", label_en: "Back View", ko: "전신: 후면 (뒷모습)", en: "full body shot from behind, back view, full outfit and hair details" },
            { label: "자연스러운 워킹 포즈", label_en: "Walking Pose", ko: "전신: 자연스러운 워킹 포즈", en: "full body shot, natural walking pose on runway, dynamic posture" }
        ]
    },
    {
        group: "하반신 엉덩이부터 다리까지 (각선미 강조)",
        group_en: "Lower Body & Legs (Hips to Feet)",
        icon: "🦵",
        items: [
            { label: "정면", label_en: "Front View", ko: "하반신 엉덩이부터 다리까지: 정면", en: "lower body shot from hips to legs, legs focus, front view, slender leg lines" },
            { label: "측면", label_en: "Side Profile", ko: "하반신 엉덩이부터 다리까지: 측면", en: "lower body shot from hips to legs, side profile view" },
            { label: "45도 측면", label_en: "3/4 View (45°)", ko: "하반신 엉덩이부터 다리까지: 45도 측면", en: "lower body shot from hips to legs, three-quarter view" },
            { label: "후면", label_en: "Back View", ko: "하반신 엉덩이부터 다리까지: 후면 (뒷모습)", en: "lower body shot from hips to legs, back view, hips and legs focus" },
            { label: "매혹적인 포즈", label_en: "Glamour Leg Pose", ko: "하반신 엉덩이부터 다리까지: 매혹적인 각선미 포즈", en: "lower body shot from hips to legs, graceful leg lines, seductive posture" }
        ]
    },
    {
        group: "엉덩이부",
        group_en: "Hips & Buttocks Focus",
        icon: "🍑",
        items: [
            { label: "정면", label_en: "Pelvis Front", ko: "엉덩이부: 골반 정면", en: "pelvis and hip area focus shot, front view" },
            { label: "측면", label_en: "Side Profile", ko: "엉덩이부: 엉덩이 측면", en: "hip and buttocks side profile shot" },
            { label: "후면", label_en: "Rear View", ko: "엉덩이부: 엉덩이 후면 (뒷모습)", en: "buttocks and rear hip focus shot, back view" },
            { label: "아래에서 본", label_en: "Low Angle", ko: "엉덩이부: 아래에서 본 (로우앵글)", en: "hip and buttocks shot, low angle, looking up" }
        ]
    },
    {
        group: "손 클로즈업",
        group_en: "Hands Close-Up",
        icon: "🖐️",
        items: [
            { label: "손등", label_en: "Back of Hand", ko: "손 클로즈업: 손등", en: "detailed close-up of back of hand, elegant hand gesture, clean manicure" },
            { label: "손바닥", label_en: "Palm View", ko: "손 클로즈업: 손바닥", en: "detailed close-up of open palm, graceful hand gesture, finger detail" }
        ]
    },
    {
        group: "발 클로즈업",
        group_en: "Feet Close-Up",
        icon: "🦶",
        items: [
            { label: "발등", label_en: "Top of Foot", ko: "발 클로즈업: 발등 (맨발)", en: "detailed close-up of top of feet and toes, feet arch, bare feet" },
            { label: "발바닥", label_en: "Sole of Foot", ko: "발 클로즈업: 발바닥", en: "detailed close-up of sole of bare foot, foot sole texture" },
            { label: "발 정면", label_en: "Front View", ko: "발 클로즈업: 발 정면", en: "detailed close-up of feet front view, toes and ankle detail" },
            { label: "발 45도 측면", label_en: "3/4 View (45°)", ko: "발 클로즈업: 발 45도 측면", en: "detailed close-up of feet three-quarter view, ankle line" },
            { label: "발 측면", label_en: "Side Profile", ko: "발 클로즈업: 발 측면", en: "detailed close-up of feet side profile, ankle and heel line" }
        ]
    }
];

// =============================================================================
// 🏷️ Known Preset Labels Bilingual Dictionary & Helper
// =============================================================================
const KNOWN_PRESET_LABELS = {
    // Character presets
    "20대 한국 여성": "20s Korean Female",
    "30대 비즈니스 남성": "30s Business Male",
    "애니메이션 미소녀": "Anime Girl",
    "40대 여성 파마머리": "40s Permed Hair Female",
    "새 인물 외모": "New Character",
    // Custom presets
    "태아자세 누운 전신": "Fetal Position Lying",
    "무릎 안고 앉기": "Sitting Hugging Knees",
    "핑크 바디슈트": "Pink Bodysuit",
    "새 구도 프리셋": "New Preset"
};

function getLocalizedPresetLabel(p, isEn) {
    if (!p) return "";
    if (isEn) {
        if (p.label_en && !/[가-힣]/.test(p.label_en)) return p.label_en;
        if (p.label && KNOWN_PRESET_LABELS[p.label]) return KNOWN_PRESET_LABELS[p.label];
        if (p.en) {
            const firstPart = p.en.split(",")[0].trim();
            if (firstPart) return firstPart.slice(0, 30);
        }
        return p.label || "";
    } else {
        if (p.label && /[가-힣]/.test(p.label)) return p.label;
        for (const [ko, en] of Object.entries(KNOWN_PRESET_LABELS)) {
            if (en === p.label_en || en === p.label) return ko;
        }
        if (p.ko) {
            const firstPart = p.ko.split(",")[0].trim();
            if (firstPart) return firstPart.slice(0, 30);
        }
        return p.label || p.label_en || "";
    }
}
...
app.registerExtension({
    name: "BadaUtils.VisualRegionalPrompt",
    async beforeRegisterNodeDef(nodeType, nodeData, app) {
        if (nodeData.name !== "BadaRegionalPrompt" && nodeData.name !== "VisualGridPromptNode" && nodeData.name !== "VisualGridPrompt") return;
        ...
        nodeType.prototype.onNodeCreated = function () {
            ...
            let charPresets = [
                { label: "20대 한국 여성", label_en: "20s Korean Female", ko: "20대 한국 여성, 긴 흑발 포니테일, 검은 뿔테 안경, 자연스러운 메이크업", en: "Korean woman in her 20s, long black hair ponytail, black horn-rimmed glasses, natural makeup" },
                { label: "30대 비즈니스 남성", label_en: "30s Business Male", ko: "30대 한국 남성, 깔끔한 댄디컷 흑발, 네이비 정장 수트", en: "Korean man in his 30s, neat dandy cut black hair, navy business suit" },
                { label: "애니메이션 미소녀", label_en: "Anime Girl", ko: "은발 트윈테일, 푸른 눈동자, 세일러복 교복", en: "silver twin-tail hair, blue eyes, sailor school uniform" }
            ];
            try {
            ...
            let areas = [];
            let customPresets = [
                { id: "cp_1", label: "태아자세 누운 전신", label_en: "Fetal Position Lying", ko: "태아자세로 누워 있는 전신", en: "Full body lying in fetal position" },
                { id: "cp_2", label: "무릎 안고 앉기", label_en: "Sitting Hugging Knees", ko: "무릎을 세우고 앉아서 양손으로 자신의 무릎을 감싸고 있는 자세의 전신", en: "Full body sitting with knees bent and covering knees with hands" },
                { id: "cp_3", label: "핑크 바디슈트", label_en: "Pink Bodysuit", ko: "핑크색 타이트한 운동 전신 슈트, 맨발, 핑크색 발톱", en: "pink tight exercise full body suit, bare feet, pink feet top" }
            ];
            try {
            ...
            artStyleBar.style.cssText = "display:flex; justify-content:flex-start; align-items:center; width:100%; flex-wrap:wrap; gap:4px;";
            ...
            const isEnInitial = (BadaI18n && BadaI18n.lang === "en") || currentLang === "English";
            artBarLabel.textContent = isEnInitial ? "🎨 Style:" : "🎨 화풍:";
            ...
            ART_STYLES.forEach(st => {
                ...
                const label = isEnInitial ? (st.short_en || st.name) : (st.short_ko || st.name);
                b.textContent = `${st.icon} ${label}`;
                b.title = isEnInitial ? (st.name_en || st.name) : st.name;
            ...
            function createStepper(initialVal, min, max, onChange) {
                ...
                return { wrap, input: numInput, btnMinus, btnPlus };
            }
            ...
            const isEnChar = (BadaI18n && BadaI18n.lang === "en") || currentLang === "English";
            ...
            charTitle.innerHTML = isEnChar ? `<span>👤 Character Profile</span>` : `<span>👤 인물 공통 외모</span>`;
            ...
            function renderCharPresetsDropdown() {
                const isEn = (BadaI18n && BadaI18n.lang === "en") || currentLang === "English";
                charSelect.innerHTML = `<option value="">${isEn ? `▼ 👤 Character Presets (${charPresets.length})` : `▼ 👤 외모 프리셋 (${charPresets.length}개)`}</option>`;
                charPresets.forEach((cp, idx) => {
                    const opt = document.createElement("option");
                    opt.value = idx;
                    const displayTxt = getLocalizedPresetLabel(cp, isEn);
            ...
            charKoInput.placeholder = isEnChar ? "KR: Korean character profile (Auto-translated to English)" : "KR: 한글 인물 공통 외모 (예: 한국인, 40대, 여성, 갈색 파마머리, 뿔테 안경...)";
            ...
            charKoInput.addEventListener("input", () => {
                ...
                if (characterProfileKo) {
                    charTransTimer = setTimeout(async () => {
                        const isEn = (BadaI18n && BadaI18n.lang === "en") || currentLang === "English";
                        charEnInput.placeholder = isEn ? "🌐 Translating..." : "🌐 번역 중...";
            ...
            btnQuickSave.addEventListener("click", () => {
                ...
                if (!ko && !en) {
                    alert(isEn ? "Please enter a character profile first." : "저장할 인물 외모 묘사를 먼저 입력해주세요.");
                    return;
                }
                const defaultLabel = isEn ? (en.slice(0, 14) || ko.slice(0, 14)) : (ko.slice(0, 14) || en.slice(0, 14));
            ...
            function renderCharManagerList() {
                ...
                charPresets.forEach((cp, idx) => {
                    ...
                    inputTitle.value = getLocalizedPresetLabel(cp, isEn);
                    inputTitle.placeholder = isEn ? "Preset Name" : "프리셋 이름";
                    inputTitle.addEventListener("input", () => {
                        if (isEn) {
                            cp.label_en = inputTitle.value;
                            if (!cp.label) cp.label = inputTitle.value;
                        } else {
                    ...
                    btnDel.title = isEn ? "Delete Preset" : "프리셋 삭제";
                    btnDel.addEventListener("click", () => {
                        const pName = getLocalizedPresetLabel(cp, isEn);
                        if (confirm(isEn ? `Delete '${pName}' preset?` : `'${pName}' 프리셋을 삭제하시겠습니까?`)) {
                ...
                btnAddRow.textContent = isEn ? "➕ Add Preset" : "➕ 새 프리셋 추가";
                btnAddRow.addEventListener("click", () => {
                    charPresets.unshift({ label: isEn ? "New Character" : "새 인물 외모", label_en: "New Character", ko: "", en: "" });
                    saveAndRefreshPresets();
                });
                ...
                btnResetDefaults.textContent = isEn ? "🔄 Reset" : "🔄 초기화";
                btnResetDefaults.title = isEn ? "Reset to default presets" : "기본 프리셋으로 초기화";
                btnResetDefaults.addEventListener("click", () => {
                    if (confirm(isEn ? "Reset all character presets to defaults?" : "모든 외모 프리셋을 기본값으로 초기화하시겠습니까?")) {
                        charPresets = [
                            { label: "20대 한국 여성", label_en: "20s Korean Female", ko: "20대 한국 여성, 긴 흑발 포니테일, 검은 뿔테 안경, 자연스러운 메이크업", en: "Korean woman in her 20s, long black hair ponytail, black horn-rimmed glasses, natural makeup" },
                            { label: "30대 비즈니스 남성", label_en: "30s Business Male", ko: "30대 한국 남성, 깔끔한 쉼표머리 헤어스타일, 네이비 정장 수트, 지적인 인상", en: "Korean man in his 30s, neat comma hairstyle, navy business suit, intellectual look" },
                            { label: "애니메이션 미소녀", label_en: "Anime Girl", ko: "밝은 은발 트윈테일, 에메랄드 보석 눈동자, 고양이 귀, 귀여운 후드티", en: "bright silver twintail hair, emerald jewel eyes, cat ears, cute oversized hoodie" },
                            { label: "40대 여성 파마머리", label_en: "40s Permed Hair Female", ko: "한국인, 40대, 여성, 뽀글뽀글 파마머리, 갈색 머리, 검정색 뿔테 안경, 큰키, 글래머", en: "Korean, 40s, female, permed hair, brown hair, black horn-rimmed glasses, tall, glamorous" }
                        ];
                        saveAndRefreshPresets();
                    }
                });
                ...
                btnCloseFooter.textContent = isEn ? "💾 Done" : "💾 완료";
            ...
            // Guide text
            const isEnStage = (BadaI18n && BadaI18n.lang === "en") || currentLang === "English";
            const guideEl = document.createElement("div");
            guideEl.style.cssText = "font-size:10px; color:#a1a1aa; text-align:center;";
            guideEl.textContent = isEnStage ? "🖱️ Drag: Create Area | ✏️ Click: Edit | ❌ Right-click or [×]: Delete" : "🖱️ 드래그: 영역 생성 | ✏️ 클릭: 구도 편집 | ❌ [×]버튼 또는 우클릭: 삭제";
            ...
            activeAreaTitle.textContent = isEnStage ? "📍 Select an area to edit (or drag on canvas)" : "📍 편집할 영역을 선택하세요 (또는 캔버스에서 드래그)";
            editorHeader.appendChild(activeAreaTitle);
            editorCard.appendChild(editorHeader);

            // Full-Width 10-Category Tree Explorer Button
            const isEnExplorer = (BadaI18n && BadaI18n.lang === "en") || currentLang === "English";
            ...
            treeSearch.placeholder = isEnExplorer ? "🔍 Search composition/angle (collarbone, walking, lying, front)..." : "🔍 구도 검색 (쇄골, 발등, 워킹, 누운, 정면)...";
            ...
            function renderExplorerTree() {
                ...
                PRESET_GROUPS.forEach(grp => {
                    ...
                    const gTitle = isEn ? (grp.group_en || grp.group) : grp.group;
                    fHead.innerHTML = `<span>${grp.icon} ${gTitle}</span> <span style="font-size:10px; color:#a1a1aa;">(${grp.items.length}) ▶</span>`;
                    ...
                    grp.items.forEach(it => {
                        ...
                        const iLabel = isEn ? (it.label_en || it.label) : it.label;
                        itEl.dataset.label = it.label;
                        itEl.dataset.label_en = it.label_en || "";
                        itEl.dataset.ko = it.ko;
                        itEl.dataset.en = it.en;
                        itEl.textContent = `📄 ${iLabel}`;
                        itEl.title = isEn ? `${it.en}\n(${it.ko})` : `${it.ko}\n(${it.en})`;
            ...
            treeSearch.addEventListener("input", () => {
                ...
                treeList.querySelectorAll(".tree-children").forEach(c => {
                    ...
                    c.querySelectorAll(".tree-item").forEach(it => {
                        const m = !q || (it.dataset.label + " " + (it.dataset.label_en || "") + " " + it.dataset.ko + " " + it.dataset.en).toLowerCase().includes(q);
            ...
            function updateCustomSelect() {
                const isEn = (BadaI18n && BadaI18n.lang === "en") || currentLang === "English";
                customSelect.innerHTML = `<option value="">${isEn ? `▼ ⭐ Custom Presets (${customPresets.length})` : `▼ ⭐ 나만의 프리셋 (${customPresets.length}개)`}</option>`;
            ...
            areaKoInput.placeholder = isEnExplorer ? "KR: Korean area prompt (Auto-translated to English)" : "KR: 한글 프롬프트 (프리셋 선택 시 1:1 교체, 한글 입력 시 실시간 자동 번역)";
            ...
            btnQuickSaveCustom.addEventListener("click", () => {
                ...
                if (!ko && !en) {
                    alert(isEn ? "Please enter a composition/pose prompt first." : "저장할 구도/포즈 프롬프트를 먼저 입력해주세요.");
                    return;
                }
                const defaultLabel = isEn ? (en.slice(0, 14) || ko.slice(0, 14)) : (ko.slice(0, 14) || en.slice(0, 14));
            ...
            function renderCustomManagerList() {
                ...
                btnAddRow.textContent = isEn ? "➕ Add Preset" : "➕ 새 프리셋 추가";
                btnAddRow.addEventListener("click", () => {
                    customPresets.unshift({ id: "cp_" + Date.now(), label: isEn ? "New Preset" : "새 구도 프리셋", label_en: "New Preset", ko: "", en: "" });
                    saveAndRefreshCustomPresets();
                });
                ...
                btnResetDefaults.style.cssText = "padding:3px 6px; font-size:10.5px;";
                btnResetDefaults.textContent = isEn ? "🔄 Reset" : "🔄 초기화";
                btnResetDefaults.title = isEn ? "Reset to default presets" : "기본 나만의 프리셋으로 초기화";
                btnResetDefaults.addEventListener("click", () => {
                    if (confirm(isEn ? "Reset all custom presets to defaults?" : "모든 나만의 프리셋을 기본값으로 초기화하시겠습니까?")) {
                        customPresets = [
                            { id: "cp_1", label: "태아자세 누운 전신", label_en: "Fetal Position Lying", ko: "태아자세로 누워 있는 전신", en: "Full body lying in fetal position" },
                            { id: "cp_2", label: "무릎 안고 앉기", label_en: "Sitting Hugging Knees", ko: "무릎을 세우고 앉아서 양손으로 자신의 무릎을 감싸고 있는 자세의 전신", en: "Full body sitting with knees bent and covering knees with hands" },
                            { id: "cp_3", label: "핑크 바디슈트", label_en: "Pink Bodysuit", ko: "핑크색 타이트한 운동 전신 슈트, 맨발, 핑크색 발톱", en: "pink tight exercise full body suit, bare feet, pink feet top" }
            ...
            btnApplyPrompt.innerHTML = `<span>${isEnExplorer ? "Apply (Ctrl+Enter)" : "적용 (Ctrl+Enter)"}</span>`;

            async function triggerApplyAndTranslate() {
                const area = getSelectedArea();
                if (!area) return;
                const isEn = (BadaI18n && BadaI18n.lang === "en") || currentLang === "English";
                btnApplyPrompt.innerHTML = `<span>${isEn ? "⏳ Translating & Applying..." : "⏳ 번역 및 적용 중..."}</span>`;
                ...
                btnApplyPrompt.innerHTML = `<span>${isEn ? "✅ Applied!" : "✅ 적용 완료!"}</span>`;
                btnApplyPrompt.style.opacity = "1";
                setTimeout(() => {
                    btnApplyPrompt.innerHTML = `<span>${isEn ? "Apply (Ctrl+Enter)" : "적용 (Ctrl+Enter)"}</span>`;
                }, 1000);
            }
            ...
            const isEnBottom = (BadaI18n && BadaI18n.lang === "en") || currentLang === "English";
            ...
            prefixInput.rows = 2;
            prefixInput.placeholder = isEnBottom ? "Prefix prompt (Masterpiece, photorealistic, lighting)..." : "접두사 (Prefix: Masterpiece, Photorealistic)...";
            prefixInput.value = prefixVal;
            ...
            suffixInput.rows = 2;
            suffixInput.placeholder = isEnBottom ? "Suffix prompt (8k resolution, cinematic lighting)..." : "접미사 (Suffix: 8k resolution, cinematic lighting)...";
            suffixInput.value = suffixVal;
            ...
            btnClear.textContent = isEnBottom ? "🗑️ Reset" : "🗑️ 초기화";
            btnClear.title = isEnBottom ? "Clear all areas" : "모든 영역 지우기";
            ...
            previewTitle.innerHTML = isEnBottom ? `<span>📋 Final Output Prompt Preview</span>` : `<span>📋 최종 프롬프트 미리보기</span>`;
            ...
            btnCopyFullPrompt.innerHTML = isEnBottom ? `<span>📋 Copy</span>` : `<span>📋 복사 (Copy)</span>`;
            ...
            btnCopyFullPrompt.addEventListener("click", (e) => {
                ...
                const isEnNow = (BadaI18n && BadaI18n.lang === "en") || currentLang === "English";
                btnCopyFullPrompt.innerHTML = `<span>${isEnNow ? "✅ Copied!" : "✅ 복사 완료!"}</span>`;
                btnCopyFullPrompt.style.background = "#10b981";
                btnCopyFullPrompt.style.borderColor = "#34d399";
                setTimeout(() => {
                    const isEnAfter = (BadaI18n && BadaI18n.lang === "en") || currentLang === "English";
                    btnCopyFullPrompt.innerHTML = `<span>${isEnAfter ? "📋 Copy" : "📋 복사 (Copy)"}</span>`;
            ...
            function selectArea(id) {
                ...
                if (area) {
                    ...
                    const titleText = isEn ? `Area [${area.id}] Prompt Settings` : `영역 [${area.id}] 프롬프트 설정`;
                    const activeBadge = isEn ? `ACTIVE` : `선택됨 (ACTIVE)`;
                    ...
                    activeAreaTitle.innerHTML = `<span style="display:inline-flex; align-items:center; gap:6px; flex-wrap:wrap;">
                        ...
                        <span style="color:${palette.border}; font-weight:800;">${titleText}</span>
                        <span style="font-size:10px; background:${palette.border}; color:#000; padding:1px 6px; border-radius:8px; font-weight:800; box-shadow:0 0 6px ${palette.glow};">${activeBadge}</span>
                    ...
                    areaKoInput.placeholder = isEn 
                        ? `👉 [Area ${area.id}] Korean prompt (1:1 replace on preset select)` 
                        : `👉 [영역 ${area.id}] 한글 프롬프트 (프리셋 선택 시 1:1 교체)`;
                    areaKoInput.style.borderColor = palette.border;
                    areaKoInput.value = area.ko_prompt || "";

                    areaEnInput.placeholder = isEn 
                        ? `👉 [Area ${area.id}] AI English prompt (Auto-translated or manual edit)` 
                        : `👉 [Area ${area.id}] AI 영문 프롬프트 (자동 번역 또는 직접 수정)`;
            ...
            function updateAllUILanguage() {
                ...
                if (artBtnGroup) {
                    artBtnGroup.querySelectorAll(".vg-btn").forEach(btn => {
                        ...
                        if (st) {
                            const label = isEn ? (st.short_en || st.name) : (st.short_ko || st.name);
                            btn.textContent = `${st.icon} ${label}`;
                            btn.title = isEn ? (st.name_en || st.name) : st.name;
                        }
                    });
                }
                if (colsStepper) {
                    if (colsStepper.btnMinus) colsStepper.btnMinus.title = isEn ? "Decrease" : "감소 (Decrease)";
                    if (colsStepper.btnPlus) colsStepper.btnPlus.title = isEn ? "Increase" : "증가 (Increase)";
                }
                if (rowsStepper) {
                    if (rowsStepper.btnMinus) rowsStepper.btnMinus.title = isEn ? "Decrease" : "감소 (Decrease)";
                    if (rowsStepper.btnPlus) rowsStepper.btnPlus.title = isEn ? "Increase" : "증가 (Increase)";
                }
                if (whiteBgSpan) whiteBgSpan.textContent = isEn ? " White BG" : " 백색 배경";
                if (whiteBgLabel) whiteBgLabel.title = isEn ? "Clean pure white studio backdrop" : "배경을 깔끔한 순백색 스튜디오로 설정";
                if (gridBorderSpan) gridBorderSpan.textContent = isEn ? " Grid Borders" : " 격자 실선";
                if (gridBorderLabel) gridBorderLabel.title = isEn ? "Demarcate each area with thin black border lines" : "각 구역을 얇은 검정색 실선으로 명확하게 분할";
                if (mockupSpan) mockupSpan.textContent = isEn ? " Silhouette" : " 실루엣";
                if (mockupLabel) mockupLabel.title = isEn ? "Render dynamic vector silhouette guides inside canvas areas" : "구도 및 포즈에 맞춘 정밀 벡터 실루엣을 캔버스 영역에 동적 표시";
                
                if (charTitle) charTitle.innerHTML = isEn ? `<span>👤 Character Profile</span>` : `<span>👤 인물 공통 외모</span>`;
                if (btnOpenCharManager) {
                    btnOpenCharManager.textContent = isEn ? "⚙️ Preset Settings" : "⚙️ 외모 프리셋 설정";
                    btnOpenCharManager.title = isEn ? "Manage character profile presets (add, edit, delete, reorder)" : "인물 외모 프리셋 관리 (추가, 수정, 삭제, 순서 변경)";
                }
                if (typeof renderCharPresetsDropdown === "function") renderCharPresetsDropdown();
                if (btnQuickSave) {
                    btnQuickSave.innerHTML = `<span>${isEn ? "⭐ Save" : "⭐ 저장"}</span>`;
                    btnQuickSave.title = isEn ? "Quickly save current character profile as a new preset" : "현재 입력된 외모를 새 프리셋으로 빠른 추가";
                }
                if (btnClearChar) {
                    btnClearChar.textContent = isEn ? "Clear" : "비우기";
                    btnClearChar.title = isEn ? "Clear character profile inputs" : "인물 외모 묘사 지우기";
                }
                ...
                if (treeSearch) treeSearch.placeholder = isEn ? "🔍 Search composition/angle (collarbone, walking, lying, front)..." : "🔍 구도 검색 (쇄골, 발등, 워킹, 누운, 정면)...";
                if (typeof renderExplorerTree === "function") renderExplorerTree();
                
                if (btnOpenCustomManager) {
                    btnOpenCustomManager.textContent = isEn ? "⚙️ Custom Presets Settings" : "⚙️ 나만의 프리셋 설정";
                    btnOpenCustomManager.title = isEn ? "Manage custom presets (add, edit, delete, reorder)" : "나만의 구도/포즈 프리셋 관리 (추가, 수정, 삭제, 순서 변경)";
                }
                if (typeof updateCustomSelect === "function") updateCustomSelect();
                if (btnQuickSaveCustom) {
                    btnQuickSaveCustom.innerHTML = `<span>${isEn ? "⭐ Save" : "⭐ 저장"}</span>`;
                    btnQuickSaveCustom.title = isEn ? "Quickly save current prompt to custom presets" : "현재 구도/포즈를 나만의 프리셋으로 빠른 추가";
                }
                if (btnClearArea) {
                    btnClearArea.textContent = isEn ? "Clear" : "비우기";
                    btnClearArea.title = isEn ? "Clear prompt for current area" : "현재 선택된 영역의 프롬프트 지우기";
                }
                if (btnApplyPrompt) btnApplyPrompt.innerHTML = `<span>${isEn ? "Apply (Ctrl+Enter)" : "적용 (Ctrl+Enter)"}</span>`;
                
                if (prefixInput) prefixInput.placeholder = isEn ? "Prefix prompt (Masterpiece, photorealistic, lighting)..." : "접두사 (Prefix: Masterpiece, Photorealistic)...";
                if (suffixInput) suffixInput.placeholder = isEn ? "Suffix prompt (8k resolution, cinematic lighting)..." : "접미사 (Suffix: 8k resolution, cinematic lighting)...";
                if (btnClear) {
                    btnClear.textContent = isEn ? "🗑️ Reset" : "🗑️ 초기화";
                    btnClear.title = isEn ? "Clear all areas" : "모든 영역 지우기";
                }
                ...
                if (fullPromptTextarea) fullPromptTextarea.placeholder = isEn ? "Generated final prompt will appear here in real time..." : "생성된 최종 프롬프트가 실시간으로 여기에 표시됩니다...";
                
                if (charManagerDrawer && charManagerDrawer.style.display !== "none" && typeof renderCharManagerList === "function") {
                    renderCharManagerList();
                }
                if (customManagerDrawer && customManagerDrawer.style.display !== "none" && typeof renderCustomManagerList === "function") {
                    renderCustomManagerList();
                }
            ...
            function renderGrid() {
                ...
                areas.forEach((area, idx) => {
                    ...
                    closeBtn.innerHTML = "×";
                    closeBtn.title = isEn ? "Delete area (Click or right-click)" : "영역 삭제 (클릭 또는 우클릭)";
                    ...
                    const defaultLabel = isEn ? "✏️ Edit" : "✏️ 작성";
                    label.textContent = (isEn ? (area.prompt || area.ko_prompt) : (area.ko_prompt || area.prompt)) || defaultLabel;
            ...
            BadaI18n.subscribe(langListener);

            const origOnRemoved = node.onRemoved;
            node.onRemoved = function () {
                BadaI18n.unsubscribe(langListener);
