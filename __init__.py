...
from .server import register_bada_api_routes
...
print("\033[36m[ComfyUI-Bada-Utils]\033[0m 🌊 All-in-One Suite (QoL, Presets, Auto-Assigner, Regional Prompt) Loaded Successfully!")
